				...
				<section id='windows-section' className='section js-section u-category-windows'>
						...
						<div className='demo-wrapper is-open'>
							<button id='new-graph-toggle' onClick={() => this.isOpen} className='js-container-target demo-toggle-button'>
								...
								<div className='demo-meta u-avoid-clicks'>
									Supports: Win, macOS, Linux <span className='demo-meta-divider'>|</span>
									Process: Main
								</div>
							</button>
							<p>
								In this demo we create a new Graph (via the <code>renderChart.js</code> script) and provide a source file
                                ...
                                */}
								...
								<div id='GraphControls' style={{ marginBottom: "10px" }} className='row'>
									<div className='col-md-12'>
										<button
											style={{ width: "100%" }}
											className='demo-button button-group'
											onClick={(e) => this.graphStart(e)}
											id='graphStart'
								...
								<div style={{ marginBottom: "10px" }} className='row'>
									<div className='col-md-4'>
										<button style={{ width: "100%" }} className='demo-button button-group' id='prevGraph' disabled>
											Previous Graph
										</button>
									</div>
									<div className='col-md-4'>
										<button style={{ marginBottom: "10px", width: "100%" }} className='demo-button ' id='sortGraph' disabled>
											Sort Graph
										</button>
									</div>
									<div className='col-md-4'>
										<button
											style={{ width: "100%" }}
											className='demo-button button-group'
											onClick={this.handleNextGraphClick}
											id='nextGraph'
											disabled={this.state.buttonState}>
											Next Graph
										</button>
								...
								<h5>input.txt</h5>
								<pre>
									<code data-path='\test\input.txt'></code>
								</pre>
							</div>
						</div>
					</div>
					...
					<div className='demo'>
						<div className='demo-wrapper'>
							<button id='new-window-hangs-demo-toggle' className='js-container-target demo-toggle-button'>
							...
							<div className='demo-box'>
								<div className='demo-controls'>
									<button className='demo-button' id='process-hang'>
										View Demo
									</button>
								</div>
								<p>
									In this demo we create a new window (via the <code>remote</code> module) and provide a link that will force the
									process to hang using
									<code>process.hang()</code>.
								</p>
								<p>
									The window is listening for the process to become officially unresponsive (this can take up to 30 seconds). When
									this event occurs it prompts the user with two options: reload or close.
								</p>

								<h5>Renderer Process</h5>
								<pre>
									<code data-path='renderer-process/windows/renderChart.js'></code>
								</pre>
								...
								<div className='demo-protip'>
									...
									<p>
										A third option in the case of a process that is hanging is to wait and see if the problem resolves, allowing
										the process to become responsive again. To do this, use the <code>BrowserWindow</code> event 'responsive' as
										shown below.
									</p>
									<pre>
