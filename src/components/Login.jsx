									...
									<div className='col-xxl-4 col-xl-5 col-lg-6 col-md-8'>
										<div className='card card-raised shadow-10 mt-5 mt-xl-10 mb-4'>
											<div className='card-body p-5'>
												...
												<form onSubmit={() => signInWithEmailPassword(data.email, data.password)}>
													<div className='mb-4'>
														<InputFrom
															name={"email"}
															label={"Email"}
										...
										<div className='text-center mb-5'>
											<a className='small fw-500 text-decoration-none link-white' onClick={() => doRegister()}>
...
export default Login;
{
	/* <form>
				...
				<button onClick={() => signInWithEmailAndPassword(email, password)} type='submit' class='btn btn-primary'>
					Login
				</button>
				<button onClick={signInWithGoogle} type='submit' class='btn btn-primary'>
					Login With Google
				</button>
			</form> */
}
